...
- もちろん、Z80が次にデータバスにアクセスするまでには、PortAはハイインピーダンスになっていなければならない。それはいつか？次のM1サイクル中のT3の立ち上がりでの命令フェッチまでだ。つまりZ80が/WAIT=Highをセンスしてから4.5クロック後。したがって、(*)部の合計 < 250 * 4.5 = 1125ns でよい。時間的には十分余裕がある。
