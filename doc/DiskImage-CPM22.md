...
- CP/M does not boot
  - DISK00.IMG is missing.
  - The system is not written to DISK00.IMG.
    - DISK00.IMG must have BDOS+CCP written to the reserved track.
    - Simply renaming an image file (for example EMPTY.IMG) to DISK00.IMG does not make it a bootable disk. Use the DISK00.IMG generated by `make`.
