...
void OUT_13_DSK_ReadPos_Low(uint8_t data)	{read_pos_low = data;}
void OUT_14_DSK_ReadPos_Mid(uint8_t data)	{read_pos_mid = data;}
void OUT_15_DSK_ReadPos_High(uint8_t data)	{read_pos_high = data;}
void OUT_16_DSK_ReadBuf_Low(uint8_t data)	{read_buf_low  = data;}
void OUT_17_DSK_ReadBuf_High(uint8_t data)	{read_buf_high = data;}
void OUT_18_DSK_ReadLen_Low(uint8_t data)	{read_buf_len_low  = data;}
void OUT_19_DSK_ReadLen_High(uint8_t data)	{read_buf_len_high = data;}
...
uint8_t IN_13_DSK_ReadPos_Low()		{return read_pos_low;}
uint8_t IN_14_DSK_ReadPos_Mid()		{return read_pos_mid;}
uint8_t IN_15_DSK_ReadPos_High()	{return read_pos_high;}
uint8_t IN_16_DSK_ReadBuf_Low()		{return read_buf_low;}
uint8_t IN_17_DSK_ReadBuf_High()	{return read_buf_high;}
uint8_t IN_18_DSK_ReadLen_Low()		{return read_buf_len_low;}
uint8_t IN_19_DSK_ReadLen_High()	{return read_buf_len_high;}
...
uint8_t IN_0A_DSK_GetDiskNumber()
{
	return disk_no;
}
...
//
FRESULT read_result;
void OUT_1A_DSK_Read(uint8_t data)
{
